# bootcamp-aws-desafio-cognito
Desafio do Bootcamp AWS da DIO de uma API com acesso gerenciado pelo Cognito

Reproduzindo abaixo a versão original do procedimento que foi seguido para chegar ao resultado final: API Gateway + Autenticação de usuário com OAuth2 no Cognito + Função Lambda em NodeJS gravando os dados da requisição no DynamoDB.

Realizado em 22/05/2023.
